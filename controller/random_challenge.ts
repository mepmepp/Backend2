...
export const randomChallenge = async(request: Request, response: Response) => {
    ...
    // if (!(typeof userDresseurId === "string")) {
    //     console.log("Invalid request. Query parameter should be convertible to int.");
    //     return response.status(400).send("<h1>Invalid request. Query parameter should be convertible to int.</h1>");
    // }
    ...
    else return console.log("random_challenge.randomChallenge - An error occured while getting the enemy dresseur.");
